# Support for Output Descriptors in Stredle Core

Since Stredle Core v0.17, there is support for Output Descriptors in the
...
on Stredle's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Stredle Core wallets, a convenience function `combo` is
