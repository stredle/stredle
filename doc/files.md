...
* stredle.conf: contains configuration settings for stredled or stredle-qt
* stredled.pid: stores the process id of stredled while running
...
* debug.log: contains debug information and general logging generated by stredled or stredle-qt
