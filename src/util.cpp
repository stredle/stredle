...
const char * const BITCOIN_CONF_FILENAME = "stredle.conf";
const char * const BITCOIN_PID_FILENAME = "stredle.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Stredle";
#else
    // Unix
