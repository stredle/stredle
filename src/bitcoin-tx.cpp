...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " stredle-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  stredle-tx [options] <hex-tx> [commands]  Update hex-encoded stredle transaction\n" +
            "or:     stredle-tx [options] -create [commands]   Create hex-encoded stredle transaction\n" +
            "\n";
