...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Stredle " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"stredletools.com", "dnsseed.stredletools.com"},
    {"stredlepool.org", "dnsseed.stredlepool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"stredletools.com", "testnet-seed.stredletools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Stredle is probably already running."), addrBind.ToString().c_str());
        else
