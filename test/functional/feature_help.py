...
"""Verify that starting stredle with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start stredle with -h for help text")
        ...
        self.log.info("Start stredle with -version for version information")
        ...
        self.log.info("Start stredled with -fakearg to make sure it does not start")
